...
resource keyVault 'Microsoft.KeyVault/vaults@2023-02-01' = {
  ...
  properties: {
    ...
    accessPolicies: [
      ...
      {
        objectId: '99ce1a75-7f7c-49d4-93cd-e10ef226034e' //my objectId
        tenantId: tenant().tenantId
        permissions: {
          certificates: [
            'all'
...
resource diskEncryptionKey 'Microsoft.KeyVault/vaults/keys@2023-02-01' = {
  ...
  properties: {
    ...
    rotationPolicy: {
      lifetimeActions: [
        {
          trigger: { //Time duration to trigger key rotation
        ...
        {
          trigger: { //Near expiry Event Grid notification
      ...
      attributes: { //The expiry time for new key version
        expiryTime: 'P1Y'
      }
    }
  }
